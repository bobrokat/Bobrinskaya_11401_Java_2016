...
public class Iphone6 extends Phone implements IphoneBehaviour, Lightable, Photoable, Calculatable, InternetConnectable {
    ...
    public void fingerPrintDecoding() {
        System.out.println("Iphone6 decodes your finger print");
    }

    @Override
    public void siri() {
        System.out.println("Iphone6 siri is on");
    }

    @Override
    public void listenToAppleMusic() {
        System.out.println("You are listening to Apple Music with your Iphone6");
    }

    @Override
    public void simpleCalculator() {
        System.out.println("Iphone6 simple calculator mmode is on");
    }

    @Override
    public void engineerCalculator() {
        System.out.println("Iphone6 engineer calculator mmode is on");
    }

    @Override
    public void programmerCalculator() {
        System.out.println("Iphone5 programmer calculator mmode is on");
    }

    @Override
    public void turnOnLight() {
        System.out.println("Iphone6 light is on");
    }

    @Override
    public void turnOffLight() {
        System.out.println("Iphone6 light is off");
    }

    @Override
    public void turnOnScreenLight() {
        System.out.println("Iphone6 screen light is on");
    }

    @Override
    public void turnOffScreenLight() {
        System.out.println("Iphone6 screen light is off");
    }

    @Override
    public void makePhoto() {
        System.out.println("Iphone6 makes photo");
    }

    @Override
    public void makePhotoWithLight(Lightable lightable) {
        lightable.turnOnLight();
        System.out.println("Iphone6 makes photo with light");
    }
    ...
    public void makeVideo() {
        System.out.println("Iphone6 makes video");
    }
    ...
    @Override
    public void useWiFi() {
        System.out.println("Your Iphone6 is connected to wifi");
    }

    @Override
    public void use3G(String mobilecompany) {
        System.out.println("Your Iphone6 uses " + mobilecompany + " 3G");
    }

    @Override
    public void use4G(String mobilecompany) {
        System.out.println("Your Iphone6 uses " + mobilecompany + " 4G");
    }

    @Override
    public void useAsWAP() {
        System.out.println("Your Iphone6 is WAP");
    }
}
