...
public class Iphone5Test {
    private static Iphone5 iphone5;
    ...
    public static void beforeclass() {
        ...
        contacts.add(kate);
        contacts.add(julia);
        iphone5 = new Iphone5("Kate", contacts, "Megafon", CaseType.plastic);
    }
    ...
    public void use3GShouldWorkCorrect() {
        assertEquals("Your Iphone5 uses Megafon 3G", iphone5.use3G(iphone5.getMobilecompany()));
    }

    @Test
    public void use4GShouldWorkCorrect() {
        assertEquals("Your Iphone5 uses Megafon 4G", iphone5.use4G(iphone5.getMobilecompany()));
    }
