...
public class Iphone4 extends Phone implements IphoneBehaviour, Photoable, Calculatable, InternetConnectable {
    ...
    public void showownerName(){
        System.out.println("Iphone4's owner is  " + this.getOwnername());
    }
    ...
    public void fingerPrintDecoding() {
        System.out.println("Iphone4 decodes your finger print");
    }

    @Override
    public void siri() {
        System.out.println("Iphone4 siri is on");
    }

    @Override
    public void listenToAppleMusic() {
        System.out.println("You are listening to Apple Music with your Iphone4");
    }

    @Override
    public void simpleCalculator() {
        System.out.println("Iphone4 simple calculator mmode is on");
    }
    ...
    public void makePhoto() {
        System.out.println("Iphone4 makes photo");
    }
    ...
    public void makeVideo() {
        System.out.println("Iphone4 makes video");
    }

    @Override
    public void makeFrontCameraPhoto() {
        System.out.println("Iphone4 makes front camera photo");
    }

    @Override
    public void useWiFi() {
        System.out.println("Your Iphone4 is connected to wifi");
    }

    @Override
    public void use3G(String mobilecompany) {
        System.out.println("Your Iphone4 uses " + mobilecompany + " 3G");
    }

    @Override
    public void use4G(String mobilecompany) {
        System.out.println("Your Iphone4 uses " + mobilecompany + " 4G");
    }
