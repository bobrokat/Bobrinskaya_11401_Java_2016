...
public class ComplexMatrix2x2Test {
    ApplicationContext ac = new AnnotationConfigApplicationContext(Task009.JavaConfig.class);


    public ComplexMatrix2x2 simpleComplexMatrix2x2 = (ComplexMatrix2x2) ac.getBean("complexMatrix2x2");
    ...
    @Before
    public void before() {
        complexMatrix1 = (ComplexMatrix2x2) ac.getBean("difcomplexMatrix2x2");
        complexMatrix2 = (ComplexMatrix2x2) ac.getBean("eqcomplexMatrix2x2");
